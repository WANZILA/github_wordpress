...
add_filter('doing_it_wrong_trigger_error', function () {return false;}, 10, 0);
  ...
  function ptc_register_styles(){
    ...
    //wp_enqueue_style('ptc_style',get_template_directory_uri()."/style.css",array('ptc_bootstrap',$version,'all');
   // wp_enqueue_style('ptc_bootstrap',"https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/css/bootstrap.min.css",'4.3.1','all');
    wp_enqueue_style('ptc_bootstrap',"https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css",'5.0.2','all');
    //wp_enqueue_style('ptc_jquery',"https://code.jquery.com/jquery-3.5.1.slim.min.js",'4.3.1','all');
   //wp_enqueue_style('ptc_js',"https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/js/bootstrap.bundle.min.js",'4.3.1','all');
   ...
   // wp_enqueue_script('main', get_theme_file_uri('/js/main.js'), NULL,'1.0.0' ,true);
    //wp_enqueue_style('styles',get_theme_file)uri('/assets/css/footer.css');

    //scripts
    wp_enqueue_script('ptc-pooper',"https://cdn.jsdelivr.net/npm/@popperjs/core@2.9.2/dist/umd/popper.min.js",'2.9.2',true);
    wp_enqueue_script('ptc-jquery',"https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js",array(),'5.0.2',true);
...
register_nav_menus(
  ...
  //   wp_enqueue_script('ptc-jquery',"https://code.jquery.com/jquery-3.3.1.slim.min.js",array(),'3.3.1',true);
  //   wp_enqueue_script('ptc-pooper',"https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js",'3.3.1',true);
  //   wp_enqueue_script('ptc-bootstrap',"https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js",'4.5.2',true);
  // }
