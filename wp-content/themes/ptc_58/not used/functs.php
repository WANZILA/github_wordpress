...
add_action( 'after_setup_theme', 'phi_theme_support' );
  ...
  function ptc_register_styles(){
   ...
   // wp_enqueue_style('ptc_bootstrap','https://cdn.jsdelivr.net/npm/bootstrap@4.5.2/dist/css/bootstrap.min.css','4.5.2','all');
  ...
  wp_enqueue_script('ptc-jquery',"https://code.jquery.com/jquery-3.5.1.slim.min.js",array(),'3.5.1',true);
    ...
    wp_enqueue_script('ptc-boot',"https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/js/bootstrap.bundle.min.js",array('ptc-jquery'),'4.5.3',true); 
    wp_enqueue_style('ptc_bootstrap','https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css','4.5.2','all');
  ...
  function ptc_register_scripts(){
    ...
    // wp_enqueue_script('ptc-boot',"https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/js/bootstrap.bundle.min.js",'4.5.3',true);   
    
   wp_enqueue_script('ptc-main-js',get_template_directory_uri()."/assets/js/main.js");
  }
